...
(custom-set-faces
 ...
 '(magit-diff-added-highlight ((t (:extend t :background "color-22"))))
 '(magit-diff-removed ((t (:extend t :background "color-88"))))
 '(magit-diff-removed-highlight ((t (:extend t :background "color-88"))))
